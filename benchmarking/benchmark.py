...
if __name__ == "__main__":
    output_name = '../train_results/Panda_FreGAN/fid.txt'
    ...
    for test_epoch in range(1,11):
        ...
        path_a = '../datasets/100-shot-panda'
        path_b = '../train_results/Panda_FreGAN/eval_' + str(test_epoch * 10000)
